...
function FeatureCard({ icon, title, description }) {
  return (
    <div className="flex flex-col items-center gap-4 border border-white/20 rounded-[10px] p-6 backdrop-blur-[50px]">
      <img src={icon} alt={title} className="w-10 h-10" />
      <p className="text-white text-[16px] font-[600] text-center">{title}</p>
      <p className="text-white-body text-[12px] font-[400] leading-[160%] text-center">
        {description}
      </p>
    </div>
  );
    ...
    <div className="px-5 md:px-15 lg:px-45">
      <div className="flex items-start justify-between mb-4 lg:mb-8">
        <div>
          ...
          <p className="text-white text-[18px] lg:text-[38px] font-[700] mb-3 lg:mb-6">
            아이디어를 실전으로 만드는 곳
          </p>
